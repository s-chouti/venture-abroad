...
<section id="hero" class="relative mx-auto mt-32 max-w-7xl px-6 text-center md:px-8">
	...
	>
		<AnimatedShinyText class="inline-flex items-center justify-center">
			<span>✨ Discover the Future of Investment ✨</span>
			{' '}
			<ArrowRightIcon
	...
	<h1
		class="-translate-y-4 animate-fade-in text-balance bg-gradient-to-br from-black from-30% to-black/40 bg-clip-text py-6 text-5xl font-medium leading-none tracking-tighter text-transparent opacity-0 [--animation-delay:200ms] sm:text-6xl md:text-7xl lg:text-8xl"
	>
		Discover Your Next Global Investment with Personalized
		<br class="hidden md:block" />
		{' '}
		Research and Expert Connections - All for Free
	</h1>
	<p
	...
	>
		Effortlessly explore overseas real estate with custom property reports, local professional
		support, and convenient financing options—designed for North American investors at zero cost.
	</p>
	<Button
