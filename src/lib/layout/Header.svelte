...
>
	...
	<div class="container flex h-14 items-center justify-between">
		<a class="text-md flex items-center" href="/"> Venture Abroad </a>

		<div class="ml-auto flex h-full items-center">
			<Button variant="secondary" class="mr-6 text-sm" on:click={gotoSignUp}>Sign up</Button>
		</div>
...
>
	<!-- {#if hamburgerMenuIsOpen === true}
		<div class="container flex h-14 items-center justify-between">
			<a class="text-md flex items-center" href="/"> SIM Defence </a>
